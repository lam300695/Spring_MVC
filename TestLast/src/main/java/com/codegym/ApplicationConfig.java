...
import com.codegym.service.Impl.ItemServiceImpl;
import com.codegym.service.Impl.SectorServiceImpl;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    @Bean
    public SectorService supplierService() {
        return new SectorServiceImpl();
    }

    @Bean
    public ItemService materialService() {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/last?useUnicode=true&characterEncoding=UTF-8");
